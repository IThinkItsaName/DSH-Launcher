...
public static class ErrorCodes
{
    ...
    public const string E1020 = "E1020"; // 宿主事实不可用，空闲自动停止本次回落到连接/CPU 启发式
    public const string E1021 = "E1021"; // 宿主报告仍有会话在跑，本次不自动停止
    ...
    public static string Describe(string code) => code switch
    {
        ...
        E1019 => "定时提醒只读快照（读不懂/因待执行提醒跳过空闲自动停止）。",
        E1020 => "宿主事实（session/list）不可用，空闲自动停止本次回落到连接/CPU 启发式。",
        E1021 => "宿主报告仍有会话在运行，本次不执行空闲自动停止。",
